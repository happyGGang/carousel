;(function () {
  ...
  class Carousel {
    constructor(carouselElement) {
      ...
      this.itemClassNmae = 'carousel_item'
    ...
    moveCarouselTo() {
      ...
      for(let i = 0; i < this.totalItems; i++) {
        if(i === this.current) {
          this.items[i].className = this.itemClassNmae + ' active'
        }else if(i === prev) {
          this.items[i].className = this.itemClassNmae + ' prev'
        } else if(i === next) {
          this.items[i].className = this.itemClassNmae + ' next'
        }else {
          this.items[i].className = this.itemClassNmae
        }
      }
    }
